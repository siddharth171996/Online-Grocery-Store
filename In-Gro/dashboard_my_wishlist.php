...
session_start();
 ...
 //$id=$_SESSION['userId'];
 /*$sql = "SELECT wishlist.wish_id, wishlist.Product_id, wishlist.user_id, product.Pid, product.Pname, product.MRP, product.Discount_mrp, product.quantity, product.image, product.vid  from wishlist join product on wishlist.Product_id = product.Pid_id where wishlist.user_id = $id";
