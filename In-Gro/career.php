...
<body>
	...
	<div class="wrapper">
						...
						<div class="default_tabs">
							<nav>
								<div class="nav nav-tabs tab_default  justify-content-center">
									...
									<a class="nav-item nav-link" href="our_blog.php">Blog</a>
									<a class="nav-item nav-link active" href="career.php">Careers</a>
									<a class="nav-item nav-link" href="press.php">Press</a>
								</div>
							</nav>						
						</div>
						<div class="title129">	
		...
		<div class="life-In-Gro">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="default-title">
							<h2>Life of In-Gro</h2>
								...
								<div class="item">
									<div class="offer-item">		
										<div class="offer-item-img">
											<img src="../../../www.In-Grolthemes.net/html-items/In-Gro_supermarket_demo/images/career/img-1.php" alt="">
										</div>
									</div>
								</div>
								<div class="item">
									<div class="offer-item">		
										<div class="offer-item-img">
											<img src="../../../www.In-Grolthemes.net/html-items/In-Gro_supermarket_demo/images/career/img-2.php" alt="">
										</div>
									</div>
								</div>
								<div class="item">
									<div class="offer-item">		
										<div class="offer-item-img">
											<img src="../../../www.In-Grolthemes.net/html-items/In-Gro_supermarket_demo/images/career/img-3.php" alt="">
										</div>
									</div>
								</div>
								<div class="item">
									<div class="offer-item">		
										<div class="offer-item-img">
											<img src="../../../www.In-Grolthemes.net/html-items/In-Gro_supermarket_demo/images/career/img-4.php" alt="">
										</div>
									</div>
								</div>
								<div class="item">
									<div class="offer-item">		
										<div class="offer-item-img">
											<img src="../../../www.In-Grolthemes.net/html-items/In-Gro_supermarket_demo/images/career/img-5.php" alt="">
										</div>
									</div>
								</div>
							</div>
		...
		<div class="life-In-Gro white-bg">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="default-title">
							<h2>The benefits of working at In-Gro</h2>
							<p>We want you to feel like home when you're working at In-Gro and for that we've curated a great set of benefits for you.</p>
							<img src="images/line.svg" alt="">
						</div>
					</div>
				</div>
