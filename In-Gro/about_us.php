...
<body>
	...
	<div class="wrapper">
						...
						<div class="default_tabs">
							<nav>
								<div class="nav nav-tabs tab_default  justify-content-center">
									...
									<a class="nav-item nav-link" href="career.php">Careers</a>
				...
				<div class="row">
					<div class="col-lg-3">
						<div class="about-step">
							...
							<h4>400+</h4>
							<p>People have joined the In-Gro team in the past six months</p>
						</div>
					</div>
					<div class="col-lg-3">
						<div class="about-step">
		...
		<div class="how-order-In-Gro">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<div class="default-title">
							<h2>How Do I Order?</h2>
							<p>How Do I order on In-Gro</p>
							<img src="images/line.svg" alt="">
						</div>
					</div>
					<div class="col-lg-4 col-md-6">
						<div class="how-order-steps">
							...
							<h4>Browse In-Gro.com for products or use the search feature</h4>
						</div>
					</div>
					<div class="col-lg-4 col-md-6">
						<div class="how-order-steps">
